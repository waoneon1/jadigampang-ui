	...
	<div class="flex text-gray90 text-sm">
		...
		<div class="part2 grow w-full p-5 text-sm">
			...
			<div class="bg-white rounded shadow-jgmain mb-5">
				...
				<div class="border-b">
					<?php $penarikan = [
						["tgl" => "27 Mei 2022", "nominal" => "Rp 2.000.000", "penjualan" => "Kotak makan plastik / Food Container / Thinwall 100ml isi 25 pcs"],
						["tgl" => "25 Mei 2022", "nominal" => "Rp 500.000", "penjualan" => "Kotak makan plastik / Food Container / Thinwall 100ml isi 25 pcs"],
						["tgl" => "17 Mei 2022", "nominal" => "Rp 1.000.000", "penjualan" => "Kotak makan plastik / Food Container / Thinwall 100ml isi 25 pcs"],
						["tgl" => "15 Mei 2022", "nominal" => "Rp 200.000", "penjualan" => "Kotak makan plastik / Food Container / Thinwall 100ml isi 25 pcs"],
						["tgl" => "27 Mei 2022", "nominal" => "Rp 2.000.000", "penjualan" => "Kotak makan plastik / Food Container / Thinwall 100ml isi 25 pcs"],
						["tgl" => "25 Mei 2022", "nominal" => "Rp 500.000", "penjualan" => "Kotak makan plastik / Food Container / Thinwall 100ml isi 25 pcs"],
						["tgl" => "17 Mei 2022", "nominal" => "Rp 1.000.000", "penjualan" => "Kotak makan plastik / Food Container / Thinwall 100ml isi 25 pcs"],
						["tgl" => "15 Mei 2022", "nominal" => "Rp 200.000", "penjualan" => "Kotak makan plastik / Food Container / Thinwall 100ml isi 25 pcs"],
					...
					<table class="w-full">
						<tr class="text-gray90 font-bold bg-gray10">
							...
							<th class="p-5 w-8/12" align="left">Penjualan</th>
						</tr>
						...
						<tr class="text-gray70 <?php echo $key%2 != 0 ? 'bg-gray10' : '' ?>">
							...
							<td class="px-5 py-2.5 text-success"><?php echo $item['nominal'] ?></td>
							<td class="px-5 py-2.5"><?php echo $item['penjualan'] ?></td>
						</tr>
						<?php endforeach ?>
					</table>
				</div>
