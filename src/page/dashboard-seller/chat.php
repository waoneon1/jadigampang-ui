	...
	<div class="flex text-gray90">
		...
		<div class="part2 grow w-full p-5 text-sm">
			<div class="mb-5 rounded shadow-jgmain flex bg-gray10" style="background-image: url(../../assets/image/bg-chat.svg);">
				<div class="w-2/5 bg-white rounded-l border-r">
					<div class="chat-header px-5 pt-5 mb-5">
 					 	...
 					 	<div class="flex mb-5">
	 		 			 	<div class="w-full flex px-1 py-1 mr-3 leading-normal w-full bg-gray20 rounded-lg shadow-none text-xs">
	 		 	        <input type="search" class="flex-initial bg-gray20 w-full py-1" placeholder="Cari percakapan">
	 		 	      ...
	 		 	      <button class="w-12 h-10 text-white bg-primary text-xl rounded flex items-center justify-center">
								+
							</button>
						</div>
					 	<button class="w-full px-3 py-2.5 text-white bg-primary text-sm rounded flex items-center justify-center">
							Kirim Broadcast Message untuk Followers
						</button>
				 	</div>
	 	      <div class="chat">
