...
<?php $active_tab = 'gagal' ?> <!-- alamat, pembayaran, notif, security -->
<?php $active_sidebar = 'pesan' ?> <!-- home, akun, pesan, notif, chat -->
<?php $active_sidebar_nav = 'gagal' ?> <!-- langganan, disukai | semua, bayar, dikemas, dikirim, selesai, gagal | transaksi, promo, sistem -->
