	...
	<?php foreach ($penilaian as $key => $value): ?>
		<div class="flex border-b pb-4 mb-4 ml-4">
			<div class="w-3/12 flex items-center">
				<div class="flex-none bg-gray90 flex items-center justify-center w-12 h-12 mr-4 font-bold rounded-full text-white"><?php echo $value ?></div>
				<div class="grow mr-8 text-xs">
					<div class="text-gray90">Buyer ID</div>
					<div class="text-gray70">2022-01-15</div>
				</div>
			</div>
			<div class="w-9/12">
				<div class="jg-rating inline-block mb-2 text-xs flex items-center">
